  ...
  module Container::Hooks
    class Base < Hook::Base
      ...
      def environment
        ...
        if !run_conf && ct.respond_to?(:get_past_run_conf)
        ...
        super.merge({
          ...
          'OSCTL_CT_DATASET' => run_conf.dataset.to_s,
          'OSCTL_CT_ROOTFS' => run_conf.rootfs,
          'OSCTL_CT_MAP_MODE' => ct.map_mode,
          'OSCTL_CT_LXC_PATH' => ct.lxc_home,
          'OSCTL_CT_LXC_DIR' => ct.lxc_dir,
          'OSCTL_CT_CGROUP_PATH' => ct.cgroup_path,
          'OSCTL_CT_DISTRIBUTION' => run_conf.distribution,
          'OSCTL_CT_VERSION' => run_conf.version,
