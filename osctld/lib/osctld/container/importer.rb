...
module OsCtld
  # An interface for reading tar archives generated by {Container::Exporter}
  class Container::Importer
    ...
    def load_streams(builder)
      load_stream(builder, 'base', true)
      load_stream(builder, 'incremental', false)
    ...
    def load_stream(builder, name, required)
      found = nil
