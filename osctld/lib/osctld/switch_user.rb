...
module OsCtld
  module SwitchUser
    ...
    # @option opts [Integer, nil] :lsmns_pid (nil)
    def self.fork_and_switch_to(sysuser, ugid, homedir, cgroup_path, **opts, &block)
      ...
      pid = self.fork(
        ...
        switch_to(
          ...
          lsmns_pid: opts.fetch(:lsmns_pid, nil)
        )
    ...
    def self.switch_to(sysuser, ugid, homedir, cgroup_path, syslogns_tag: nil, syslogns_pid: nil, tracingns_pid: nil, lsmns_pid: nil)
