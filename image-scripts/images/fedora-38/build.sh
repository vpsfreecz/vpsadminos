...
RELEASE="$BASEURL/Packages/f/fedora-release-server-$RELVER-34.noarch.rpm
$BASEURL/Packages/f/fedora-release-$RELVER-34.noarch.rpm
$BASEURL/Packages/f/fedora-release-common-$RELVER-34.noarch.rpm
$BASEURL/Packages/f/fedora-release-identity-basic-$RELVER-34.noarch.rpm"
