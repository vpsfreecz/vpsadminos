...
RELEASE="$BASEURL/Packages/f/fedora-release-server-$RELVER-30.noarch.rpm
$BASEURL/Packages/f/fedora-release-$RELVER-30.noarch.rpm
$BASEURL/Packages/f/fedora-release-common-$RELVER-30.noarch.rpm
$BASEURL/Packages/f/fedora-release-identity-basic-$RELVER-30.noarch.rpm"
