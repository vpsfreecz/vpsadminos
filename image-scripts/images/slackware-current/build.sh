...
SLACKWARE_POWER_PACKAGE_AFTER_NETWORK_SCRIPTS=nut
...
# Setup slackpkg
# This is to subdue warnings about using the current branch
(. /etc/slackpkg/slackpkg.conf && touch \$WORKDIR/current)
