import ../../make-test.nix (
  { pkgs }:
  {
    ...
    testScript = ''
      ...
      # An in-namespace SIGKILL to PID 1 can be ignored by the namespace init;
      # kill the exact host PID reported by this CT in the test VM instead.
      machine.succeeds("kill -9 #{init}")
