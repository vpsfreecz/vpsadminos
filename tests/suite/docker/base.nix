...
import ../../make-test.nix (pkgs: {
  ...
  testScript = ''
    ...
    machine.wait_until_succeeds("osctl ct exec docker bash -c 'ping -c 1 vpsadminos.org || curl --head https://vpsadminos.org || wget -O - https://vpsadminos.org || getent hosts vpsadminos.org'")
