import ../../make-test.nix (
  { pkgs }:
  {
    ...
    testScript = ''
      ...
      # NB: the uname-suffix expects were removed for the no-uname-era payload
      # (no module-driven release surfaces); `wait_enabled` and the patch-dir
      # absence checks carry the runtime identity coverage.
