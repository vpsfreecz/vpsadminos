{
  ...
  osctl-repo = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "100k17fa0s9p4l6pfypb0swbxl7mbcnsf6c179zdq6ifrdxvlv04";
      type = "gem";
    };
    version = "23.05.0.build20230610164410";
  };
  osctld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "07xj7ff8xjxa1mbn89c647m7a5v4hsdzbvyc219rcpq8nml29b8h";
      type = "gem";
    };
    version = "23.05.0.build20230610164410";
  };
  osup = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0n3hryibv7hxk18cl57lnmgqnv6vb8p8a6kswg6i4vi0337l8hay";
      type = "gem";
    };
    version = "23.05.0.build20230610164410";
  };
