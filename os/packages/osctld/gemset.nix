{
  ...
  libosctl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "19grvwx20496ydk4hwbagd02063xqip0y1mv7w0f8js2vzfk5hgs";
      type = "gem";
    };
    version = "21.11.0.build20220826193957";
  };
  netlinkrb = {
    groups = ["default"];
    platforms = [];
  ...
  osctl-repo = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1dcim2r64b4phqig3w5ydl8pad1n1j0s0s3xksqi8n6h5bayw3fg";
      type = "gem";
    };
    version = "21.11.0.build20220826193957";
  };
  osctld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0lmk805kqzrrjmz2wkcncyy2pha1ivbq83cz4xx2wsj8862414il";
      type = "gem";
    };
    version = "21.11.0.build20220826193957";
  };
  osup = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1ngh2f9siy6qkw8gwkqgfcv7xr0pvsxcp03i9zla07mnmm8xf7xx";
      type = "gem";
    };
    version = "21.11.0.build20220826193957";
  };
