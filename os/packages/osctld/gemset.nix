{
  ...
  osctl-repo = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "051vjh0x36xmknm46xdsca08xwl3y2b20py6wg1absqz22n9m2rq";
      type = "gem";
    };
    version = "24.05.0.build20241021092749";
  };
  osctld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0apdh5gdm1mjrrgyi5hdp5p325pdigrzgwiq6005pkca8iirzxc8";
      type = "gem";
    };
    version = "24.05.0.build20241021092749";
  };
  osup = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "13nx1y2yvbr84m7dw91ly90s4z9chgl2fj5p69d1kyx1jr9xiq33";
      type = "gem";
    };
    version = "24.05.0.build20241021092749";
  };
