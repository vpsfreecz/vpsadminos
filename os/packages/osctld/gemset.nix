{
  ...
  osctl-repo = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1cqvca7130zhwc0jxrwxv21lrgx9rmfpbkbz67yc7v24shhlq039";
      type = "gem";
    };
    version = "25.05.0.build20250716105744";
  };
  osctld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "17gbz23wgj693p26l3mjsjinyydasgrpdz8cni4h78wb8ns7qm5l";
      type = "gem";
    };
    version = "25.05.0.build20250716105744";
  };
  ...
  osup = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1ingy3csm4qkd6bdjx349kdzl34wlxwaxamgl99vdg30s8apn6ln";
      type = "gem";
    };
    version = "25.05.0.build20250716105744";
  };
