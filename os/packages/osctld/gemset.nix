{
  ...
  libosctl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0vybz1iqdqf34ywm8bgfgl64b5c477ki7d50x9r3xfwgz89b56pb";
      type = "gem";
    };
    version = "22.11.0.build20230509085202";
  };
  netlinkrb = {
    groups = ["default"];
    platforms = [];
  ...
  osctl-repo = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0mz3c5qgs6rhz20p8zqb5vk45lg65drsix8zzmlmml7p3z88znwq";
      type = "gem";
    };
    version = "22.11.0.build20230509085202";
  };
  osctld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "00jl7vvkamkx6pkvih7rvg6jxll9p8ghnz1adhan3s4bnvr9wvhd";
      type = "gem";
    };
    version = "22.11.0.build20230509085202";
  };
  osup = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "00v37fzbjwv43pa1w8753343gl6cj2w1rkgjk7xm3hkvm216y72b";
      type = "gem";
    };
    version = "22.11.0.build20230509085202";
  };
