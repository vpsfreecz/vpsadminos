{
  ...
  libosctl = {
    ...
    source = {
      ...
      sha256 = "0r47dwfpg6nw367a8zcjrr62yb6pi3y3arvh1zkg8adg0y9fnb72";
      type = "gem";
    };
    version = "25.11.0.build20260501011905";
  };
  logger = {
    groups = ["default"];
    platforms = [];
  ...
  osctl-repo = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1rwyzw0vsw9y65rqaidr8yjl1cp48wgv2gsb2ivjf8m8k4z3xy43";
      type = "gem";
    };
    version = "25.11.0.build20260501011905";
  };
  osctld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1rmhz25hi936f8q473bj7557p11a0zlzzmwgs6am51jf9k3pyyx5";
      type = "gem";
    };
    version = "25.11.0.build20260501011905";
  };
  ...
  osup = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1ii7rmakji3aq7d6j2kxcnr0vngqknifggxm2vwlbz6lavxj7nsp";
      type = "gem";
    };
    version = "25.11.0.build20260501011905";
  };
