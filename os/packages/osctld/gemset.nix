{
  ...
  osctl-repo = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1fzdhb45jqm9pa8ywp1869gw7427xqlgqm6m8sddpj003j59bf15";
      type = "gem";
    };
    version = "19.09.0.build20200308081413";
  };
  osctld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0pkixin2ynhps4pzlgqq26sd6lrwldn8jwd7n00njl9yz1gva5ay";
      type = "gem";
    };
    version = "19.09.0.build20200308081413";
  };
  osup = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "063mssh88pimcwy9zbqr785cikbv9hhizcvyhh61abwrhnzx0cvp";
      type = "gem";
    };
    version = "19.09.0.build20200308081413";
  };
