...
with lib.kernel;
{
  ...
  kernels = {
    "6.18" = {
      rev = "819c307e3ef6ba0f4b1cf00c3269e95ec00545c3";
      sha256 = "sha256-qsxpIgrmOMFhUlKDVnMlJ0avXuUbv9JGz73fJwRmuwY=";
      ...
      zfs = {
        rev = "440775b6078301207c57b6da49faffb17bb761ff";
        sha256 = "sha256-MdNt20IU6RBatG6BVctmIYKgjsIkNkJ1+fnAHuWrFcQ=";
      };
    };
    "6.12.81" = {
