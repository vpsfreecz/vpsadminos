...
let
  ...
  pstore =
    if builtins.hasAttr "pstore" features then
      features.pstore
    else if versionAtLeast version "6.1.54" then
      true
    else
      false;

  RTKernel = if builtins.hasAttr "preempt_rt" features then features.preempt_rt else false;
