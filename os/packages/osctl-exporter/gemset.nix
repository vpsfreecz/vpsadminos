{
  ...
  osctl = {
    ...
    source = {
      remotes = [ "https://rubygems.vpsfree.cz" ];
      sha256 = "08bqmzxk0s8v8mscnq1rsfmps34smfr43vhgxnibqwxzkfha6n83";
      type = "gem";
    };
    version = "25.11.0.build20260323202339";
  };
  osctl-exporter = {
    ...
    source = {
      remotes = [ "https://rubygems.vpsfree.cz" ];
      sha256 = "0b83j25mbyirysw3iliqg63mnrriydkv4zazjg0ykvkkbwg6pllk";
      type = "gem";
    };
    version = "25.11.0.build20260323202339";
  };
  osctl-exportfs = {
    ...
    source = {
      remotes = [ "https://rubygems.vpsfree.cz" ];
      sha256 = "048ywk35mvqiy15xmyh3ajbqm0i29q2nyki4gi6wvykswzbcia43";
      type = "gem";
    };
    version = "25.11.0.build20260323202339";
  };
