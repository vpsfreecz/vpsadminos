{
  ...
  libosctl = {
    ...
    source = {
      ...
      sha256 = "11m3k5l6qnfcad04d2p6hlbsb3gg0709c0182jjl58j84zx7yhyj";
      type = "gem";
    };
    version = "25.05.0.build20251013211210";
  };
  logger = {
    groups = [ "default" ];
    platforms = [ ];
  ...
  osctl = {
    ...
    source = {
      remotes = [ "https://rubygems.vpsfree.cz" ];
      sha256 = "11hs9pscikgl0ss2aaq9jiyp20fsrqxim3iicrj99rhgwgxzsml5";
      type = "gem";
    };
    version = "25.05.0.build20251013211210";
  };
  osctl-image = {
    ...
    source = {
      remotes = [ "https://rubygems.vpsfree.cz" ];
      sha256 = "1967m0ahskvq5nmwc07kvyww6g3da7lld4yymf0lwv2jypjms1qq";
      type = "gem";
    };
    version = "25.05.0.build20251013211210";
  };
  osctl-repo = {
    ...
    source = {
      remotes = [ "https://rubygems.vpsfree.cz" ];
      sha256 = "1d1gmr89lnx4s9gxj7xckxjkscj6la2fprf49p79a54vrzdcjmfz";
      type = "gem";
    };
    version = "25.05.0.build20251013211210";
  };
