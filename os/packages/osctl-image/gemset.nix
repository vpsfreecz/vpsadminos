{
  ...
  libosctl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "008yl8s7z9j5s7ddzaa6vzn3rp10r59qwd4krsa4qcq4y6zh8rjw";
      type = "gem";
    };
    version = "22.11.0.build20230514200616";
  };
  osctl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "01mnzxh1dkwfi5rmwb5q7l7z6cdwrf4lxy5whs3yjcqsg640j300";
      type = "gem";
    };
    version = "22.11.0.build20230514200616";
  };
  osctl-image = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1h3mv7dnlk9c4x8xc58qfmxns71yb4dclw6qv27r20bp6fq6j3sh";
      type = "gem";
    };
    version = "22.11.0.build20230514200616";
  };
  osctl-repo = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1izpm2lxng3kzfqb667hwlgf5w3i455yk9kximk3gkk0w3223icv";
      type = "gem";
    };
    version = "22.11.0.build20230514200616";
  };
