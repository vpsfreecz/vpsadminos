{
  ...
  libosctl = {
    ...
    source = {
      ...
      sha256 = "0vsyxgmsgn4fmgpkpgm6yfc1c4vglni9sy7dcbmqcjg49bq6xd0s";
      type = "gem";
    };
    version = "25.11.0.build20260322190433";
  };
  logger = {
    groups = [ "default" ];
    platforms = [ ];
  ...
  osctl = {
    ...
    source = {
      remotes = [ "https://rubygems.vpsfree.cz" ];
      sha256 = "0cc34p5n712403gpsnzdwvk330kk522xvwx9dh0n345mwqby9cp2";
      type = "gem";
    };
    version = "25.11.0.build20260322190433";
  };
  osctl-image = {
    ...
    source = {
      remotes = [ "https://rubygems.vpsfree.cz" ];
      sha256 = "1c043yjqbmlpjri9cgm3al3dawbdz89hi0gkzdrsx7lv0pgidzdq";
      type = "gem";
    };
    version = "25.11.0.build20260322190433";
  };
  osctl-repo = {
    ...
    source = {
      remotes = [ "https://rubygems.vpsfree.cz" ];
      sha256 = "1zh0cw5z0vcv74qx6sb8ywswg8c6nllhyzmj3jcr0pfciafbz3cm";
      type = "gem";
    };
    version = "25.11.0.build20260322190433";
  };
