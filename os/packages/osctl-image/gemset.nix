{
  ...
  libosctl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0dpc58hj4rzdljqg1n27ng67fp6bb7s7vzrrpshpd69h9kzl0hdx";
      type = "gem";
    };
    version = "20.03.0.build20200921164932";
  };
  osctl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1gjmwy776kv30k8g7v3p0bczy83hg8fs5wswmf3swcxfhnifsrkl";
      type = "gem";
    };
    version = "20.03.0.build20200921164932";
  };
  osctl-image = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1a3xyaz6jwwq3i9s5cj7pb2150cr9y2px9j4yb2j4i9k6iprsx0f";
      type = "gem";
    };
    version = "20.03.0.build20200921164932";
  };
  osctl-repo = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "16k8m5v73zmjr31hliv83yilh2kscnck9nr829rpnfr6gjsw0ypf";
      type = "gem";
    };
    version = "20.03.0.build20200921164932";
  };
