{
  ...
  libosctl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "09z3gikhdy1msia576nj3g4b21mnb0ldgc8ak9csqfcfmy64y1ky";
      type = "gem";
    };
    version = "19.03.0.build20190424153301";
  };
  osctl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0aqiphpsgh5lbfy86q625d0x4716pp3a6zzfxrvyvx78mm2diq23";
      type = "gem";
    };
    version = "19.03.0.build20190424153301";
  };
