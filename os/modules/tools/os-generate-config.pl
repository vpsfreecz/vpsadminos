...
for (my $n = 0; $n < scalar @ARGV; $n++) {
    my $arg = $ARGV[$n];
    if ($arg eq "--help") {
        exec "man os-generate-config" or die;
    }
    elsif ($arg eq "--dir") {
        $n++;
        $outDir = $ARGV[$n];
...
my $hwConfig = <<EOF;
# Do not modify this file!  It was generated by ‘os-generate-config’
...
# and in the vpsAdminOS manual (accessible by running ‘os-help’).
