...
let
  ...
  grubConfig = args:
    ...
    { splashImage = f cfg.splashImage;
      ...
      bootloaderId = if args.efiBootloaderId == null then "${config.system.vpsadminos.distroName}${efiSysMountPoint'}" else args.efiBootloaderId;
  ...
  options = {
    ...
    boot.loader.grub = {
      ...
      entryOptions = mkOption {
        ...
        type = types.nullOr types.str;
        description = lib.mdDoc ''
          Options applied to the primary vpsAdminOS menu entry.
      ...
      subEntryOptions = mkOption {
        ...
        type = types.nullOr types.str;
        description = lib.mdDoc ''
          Options applied to the secondary vpsAdminOS submenu entry.
