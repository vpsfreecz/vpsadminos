...
let
  ...
  grubConfig = args:
    ...
    { splashImage = f cfg.splashImage;
      ...
      inherit (cfg)
        ...
        extraEntriesBeforeVpsAdminOS extraPrepareConfig configurationLimit copyKernels
  ...
  defaultSplash = ../../../../../../artwork/boot.png;
in
    ...
    boot.loader.grub = {
      ...
      forcei686 = mkOption {
        ...
        description = ''
          ...
          to install and run vpsAdminOS on 64bit x86 systems with 32bit (U)EFI.
        '';
      };
