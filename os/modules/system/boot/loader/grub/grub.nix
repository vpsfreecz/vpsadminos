...
let
  ...
  grubConfig = args:
    ...
    { splashImage = f cfg.splashImage;
      ...
      bootloaderId = if args.efiBootloaderId == null then "vpsAdminOS${efiSysMountPoint'}" else args.efiBootloaderId;
      ...
      inherit (cfg)
        ...
        extraEntriesBeforeVpsAdminOS extraPrepareConfig extraInitrd configurationLimit copyKernels
  ...
  options = {
    ...
    boot.loader.grub = {
      ...
      extraPerEntryConfig = mkOption {
        ...
        description = ''
          Additional GRUB commands inserted in the configuration file
          at the start of each vpsAdminOS menu entry.
        '';
      };
      ...
      efiInstallAsRemovable = mkOption {
        ...
        description = ''
          ...
          *not* booted in UEFI mode at the time GRUB is being installed, the
          ...
          <itemizedlist>
            <listitem><para>You are installing vpsAdminOS and want it to boot in UEFI mode,
  ...
  config = mkMerge [
    ...
    (mkIf cfg.enable {
      ...
      system.build.installBootLoader =
        ...
        #!${pkgs.runtimeShell}
        set -e
        export PERL5LIB=${with pkgs.perlPackages; makePerlPath (with pkgs.perlPackages; [ FileSlurp XMLLibXML XMLSAX XMLSAXBase ListCompare ])}
