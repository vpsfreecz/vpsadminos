  ...
  serviceRun =
    ...
    let
      ctNewArgList =
        ...
        ++ (optional (cfg.image.repository != null) ''--repository "${cfg.image.repository}"'');
      ...
      createMethod = if cfg.image.path == null then createMethods.ct-new else createMethods.ct-import;
